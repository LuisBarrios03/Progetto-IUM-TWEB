...
public class Movies {
    ...
    public Posters getPosters() { return posters; }
    public void setPosters(Posters posters) { this.posters = posters; }

    public List<Actors> getActors() { return actors; }
    public void setActors(List<Actors> actors) { this.actors = actors; }
    ...
    public List<Crews> getCrews() { return crews; }
    public void setCrews(List<Crews> crews) { this.crews = crews; }
    ...
    public List<Releases> getRelease() { return release; }
    public void setRelease(List<Releases> release) { this.release = release; }
