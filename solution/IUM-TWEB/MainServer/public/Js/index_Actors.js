async function init() {
    ...
    try {
        ...
        if (!actorName) {
           ...
           response = await axios.get(`http://localhost:8080/movies/name`, {
                params: { actorName } // Usa 'actorName' invece di 'name'
            });
        }
        ...
        actors.forEach(actor => {
            ...
            let posterUrl = (actor.link != null) ? actor.link : "https://a.ltrbxd.com/resized/film-poster/6/4/1/9/6/1/641961-bullet-train-0-230-0-345-crop.jpg?v=9245faa1ba";
            let rating = actor.rating !== null ? actor.rating : 0;
            let stars = generateStars(rating);
            card.innerHTML = `
                    <div class="card shadow-lg p-3 mb-5 bg-white rounded">
                        <img src="${posterUrl}" class="card-img-top" alt="${actor.name}">
                        <div class="card-body">
